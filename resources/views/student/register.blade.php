                    ...
                    <div class="p-5">
                        ...
                        <form class="user" method="post" action="{{ route('register') }}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6 mb-3 mb-sm-0">
                                    <input type="number" class="form-control form-control-user" id="exampleInputEmail" placeholder="0321xxxxxxx" name="phone_number" value="{{ old('phone_number') }}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6">
                                    <input type="password" name="password_confirmation" class="form-control form-control-user" id="exampleRepeatPassword" placeholder="Repeat Password" value="{{ old('password_confirmation') }}">
